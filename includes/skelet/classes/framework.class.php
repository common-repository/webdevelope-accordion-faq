  ...
  class SkeletFramework extends SkeletFramework_Abstract {
    ...
    public function admin_menu() {
      ...
      if(!defined( 'SK_PARENT_MENU' )){
        ...
        call_user_func("add_menu_page", "iProDev", "iProDev", "pa-nonexistent-capability", SK_PARENT_MENU, null, $args['menu_icon'], $args['menu_position'] );
      }
       
        
      if( $args['menu_type'] == 'add_submenu_page' ) {
        call_user_func( $args['menu_type'], "edit.php?post_type=faq", $args['header_title'], $args['menu_title'], $args['menu_capability'], $args['menu_slug'], array( &$this, 'admin_page' ) );
      } 
    ...
    public function admin_page() {
      ...
      echo '<div class="sk-framework sk-option-framework">';
        ...
        echo sprintf('%s',
            ...
            //$this->settings['header_title']." <small>".$this->settings['current_version']."</small>":"Skelet Framework <small>by iProDev</small>"); 
            $this->settings['header_title']:"Skelet Framework"); 
        echo '</h1>';
        echo '<p class="feedback"><a target="_blank" href="https://www.webdevelope.net/contact/">Feedback</a></p>';
        echo '<fieldset>';
      ...
      global $skelet_path;
      echo '<footer class="sk-footer" style="font-size: 16px;font-weight: 400;font-style: italic;text-transform: uppercase;word-spacing: 6px; color:#999"><i class="si-embed2"></i> with <i class="si-heart3"></i> by <a href="http://webdevelope.net">iProDev</a></footer>'; // end .sk-footer
